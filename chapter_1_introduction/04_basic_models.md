...
The preceding visualization suggests one model for introducing temporal correlation in a series.
...
Both depend on the values $w_2$ and $w_3$, creating correlation between consecutive observations.
...
where the $w_t$'s are iid white noise.
