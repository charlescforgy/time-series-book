...
While the above are all examples of time series this text will focus on purely numeric data. Non-numeric data will be assumed to be encoded in a numeric form such as $Health=0$, $Warning=1$, etc.
